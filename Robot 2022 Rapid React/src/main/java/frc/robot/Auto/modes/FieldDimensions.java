...
public class FieldDimensions 
{
    ...
    // Ball Positions
    public static final Vector2d redBall2of2  = new Vector2d(116, -28.5);   // near hangar
    public static final Vector2d blueBall2of2  = new Vector2d(117, -26);   // near hangar
    public static Vector2d[] ball2of2  = new Vector2d[]{redBall2of2, blueBall2of2};
    public static final Vector2d redTheirBall = new Vector2d(95, -85);    // left wall
    public static final Vector2d blueTheirBall = new Vector2d(97, -82);    // left wall
    ...
    // Ball Positions
    public static final Vector2d redBall2of3   = new Vector2d(115, 31);   // right wall
    public static final Vector2d blueBall2of3   = new Vector2d(114, 31);   // right wall
    public static final Vector2d[] ball2of3 = new Vector2d[]{redBall2of3,blueBall2of3};
    public static final Vector2d redBall3of3   = new Vector2d(95, -83);   // near center
    public static final Vector2d blueBall3of3   = new Vector2d(93, -85);   // near center
