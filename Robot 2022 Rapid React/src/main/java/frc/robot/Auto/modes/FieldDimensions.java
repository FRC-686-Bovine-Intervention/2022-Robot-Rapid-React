...
public class FieldDimensions 
{
    ...
    // Ball Positions
    public static final Vector2d redBall2of2  = new Vector2d(115.5, -34);   // near hangar
    ...
    public static final Vector2d redTheirBall = new Vector2d(91, -87);    // left wall
    public static final Vector2d blueTheirBall = new Vector2d(93.5, -85);    // left wall
    ...
    // Ball Positions
    public static final Vector2d redBall2of3   = new Vector2d(116, 27.5);   // right wall
    ...
    public static final Vector2d redBall3of3   = new Vector2d(97, -82);   // near center
